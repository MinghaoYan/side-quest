#!/bin/bash
# Thin launcher for the KuaRec/FuXi task on Qwen3-4B-Thinking-2507.
...
#
# Keep DP size at 1 by default for rollout_batch_size=1 launches. With TP=2 on 4
# training GPUs, Megatron creates 2 DP partitions and the group-aware rollout
# partitioner can fail when a rollout step only contains a single prompt group.
