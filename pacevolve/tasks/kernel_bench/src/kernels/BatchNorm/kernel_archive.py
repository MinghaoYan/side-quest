...
# compiled=True correctness=True metadata={'hardware': 'NVIDIA A100-SXM4-40GB', 'device': '0', 'correctness_trials': '(1 / 1)'} runtime=0.851 runtime_stats={'mean': 0.851, 'std': 0.0144, 'min': 0.841, 'max': 0.892, 'num_trials': 10}