...
class EvolvingGymManager:
    ...
    def __init__(self, args, tokenizer):
        ...
        self.gym = SingleTaskEvolvingGym(
            ...
            use_puct_reuse=getattr(args, "use_puct_reuse", False),
            puct_exploration_coef=getattr(args, "puct_exploration_coef", 1.0),
            puct_archive_size=getattr(args, "puct_archive_size", 1000),
            puct_top_children_per_parent=getattr(args, "puct_top_children_per_parent", 2),
        )
