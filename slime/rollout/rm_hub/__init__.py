...
from .pacevolve_gym_rm import pacevolve_gym_rm
import json
...
async def async_rm(args, sample: Sample, **kwargs):
    ...
    if rm_type in ["evolving-gym", "pacevolve-gym"]:
        if rm_type == "evolving-gym":
            return await evolving_gym_rm(args=args, sample=sample)
        elif rm_type == "pacevolve-gym":
            return await pacevolve_gym_rm(args=args, sample=sample)
