...
MULTIEVOLVE_MAX_ITERS="${MULTIEVOLVE_MAX_ITERS:-200}"
...
export PACEVOLVE_ROLLOUT_BATCH_SIZE="${PACEVOLVE_ROLLOUT_BATCH_SIZE:-2}"
...
export PACEVOLVE_MAX_CONCURRENT_EVALS="${PACEVOLVE_MAX_CONCURRENT_EVALS:-4}"
